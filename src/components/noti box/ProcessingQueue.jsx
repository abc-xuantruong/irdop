	...
	return (
		<>
			{queueMinimized ? (
				...
				// Expanded view - Full queue panel
					...
					<div className="sticky top-0 bg-gradient-to-r from-blue-500 to-blue-600 text-white px-4 py-3 rounded-t-lg flex justify-between items-center">
						...
						<div className="flex items-center gap-2 text-black">
							...
							<button
								...
								className="hover:text-red-600 text-xl px-2 py-1 font-bold"
								title="Xóa tất cả"
							>
								✕
							</button>
									...
									<div className="flex-1 min-w-0">
										...
										<div className="flex items-center justify-between mt-2">
											...
											<span className="text-xs text-gray-500">
												{task.timestamp.toLocaleTimeString('vi-VN', {
													hour: '2-digit',
													minute: '2-digit',
												})}
											</span>
