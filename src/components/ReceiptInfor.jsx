...
const ReceiptInfor = ({ receipt }) => {
    ...
    const formatDateString = (dateStr) => {
        ...
        if (normalized.length === 8) {
            ...
            return `${normalized.substring(0, 2)}/${normalized.substring(
                2,
                4,
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                if (receiptData.receipt_date) {
                    receiptData.receipt_date = adjustTimezoneDate(
                        receiptData.receipt_date,
                    );
                }
                if (receiptData.deadline) {
                    receiptData.deadline = adjustTimezoneDate(
                        ...
                        if (sample.analysis) {
                            sample.analysis.forEach((analysis) => {
                                if (analysis.deadline) {
                                    analysis.deadline = adjustTimezoneDate(
                                        analysis.deadline,
                                    );
                                }
                            });
                ...
                setListAnalytes(
                    receiptData.samples.flatMap((sample) => sample.analysis),
                );
    ...
    const handleSampleApiUpdate = async (sampleId, field, newValue) => {
        try {
            ...
            if (response.status === 200) {
                ...
                Swal.fire({
                    ...
                    text:
                        ...
                        "Lỗi khi cập nhật thông tin mẫu",
                });
            ...
            Swal.fire({
                ...
                title: "Lỗi",
                text:
                    error.message || "Có lỗi xảy ra khi cập nhật thông tin mẫu",
            });
            fetchReceipt(); // Refresh data on error
        }
    };
    ...
    const getSampleUid = (sample_id) => {
        const sample = currentReceipt.samples.find(
    ...
    const getTechnicianName = (technician_uid) => {
        const technician = technicians.find(
            (tech) => tech.identity_uid === technician_uid,
        );
        return technician
            ? `${technician.identity_name} (${technician.alias})`
            : "";
    };
    ...
    const handleSaveNewSample = async () => {
        ...
        try {
            const response = await apiPost(
                "https://black.irdop.org/to82oe92i/db/insert/sample",
            ...
            if (response.status === 200) {
                ...
                Swal.fire({
                    ...
                    text:
                        response.data?.message ||
                        "Thêm mẫu mới thất bại. Vui lòng thử lại",
                });
            }
        } catch (error) {
            Swal.fire({
    ...
    const handleAdditionalFieldChange = (index, field, value) => {
        ...
        if (field === "fname") {
            const selectedField = defaultFields.find(
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                Swal.fire({
                    ...
                    text:
                        response.data?.message ||
                        "Xóa mẫu thất bại. Vui lòng thử lại",
                });
            }
        } catch (error) {
            Swal.fire({
    ...
    const handleDeleteReceipt = async () => {
        try {
            const response = await apiPost(
                "https://black.irdop.org/khsi19me/db/delete/receipt",
                {
            ...
            if (response.status === 200) {
                ...
                Swal.fire({
                    ...
                    text:
                        response.data?.message ||
                        "Xóa tiếp nhận mẫu thất bại. Vui lòng thử lại",
                });
            }
        } catch (error) {
            Swal.fire({
    ...
    const handleCopySample = (sampleUid) => {
        ...
        const sampleToCopy = currentReceipt.samples.find(
        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center">
            <div className="bg-white p-4 rounded-lg w-1/2">
                        ...
                        <div className="mb-4">
                            ...
                            <textarea
                                ...
                                className={`w-full border rounded p-1 bg-white resize-none ${
                                    checkConfirm &&
                                    newSample.sample_description.trim() === ""
                                        ? "border-red-500"
                                        : ""
                                }`}
                                rows={2}
                    ...
                    <div className="w-1/2 pl-2">
                        ...
                        <div className="mb-4">
                            ...
                            <select
                                ...
                                className={`w-full border rounded p-1 bg-white ${
                                    checkConfirm &&
                                    newSample.purpose.trim() === ""
                                        ? "border-red-500"
                                        : ""
                                }`}
                            >
                                <option value="">
                                    Chọn mục đích kiểm nghiệm
                                </option>
                    ...
                    {sampleInformation.map((field, index) => (
                        <div key={index} className="flex mb-2">
                            ...
                            <button
                                ...
                                onClick={() =>
                                    handleDeleteAdditionalField(index)
                                }
                            >
                                <FaTrashAlt size={20} />
                            </button>
                ...
                <div className="flex justify-end mt-4">
                    ...
                    <button
                        className="bg-gray-500 text-white text-sm rounded-lg p-1 mr-2 w-20"
                        onClick={handleCancelAddSample}
                    >
                        Hủy bỏ
                    </button>
                    <button
                        className="bg-green-500 text-white text-sm rounded-lg p-1 w-20"
                        onClick={handleSaveNewSample}
                    >
                        Lưu
                    </button>
                </div>
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                Swal.fire({
                    ...
                    text:
                        response.data?.message ||
                        "Xóa chỉ tiêu thất bại. Vui lòng thử lại",
                });
            }
        } catch (error) {
            Swal.fire({
    ...
    const handleExcelDownload = async () => {
        try {
            ...
            const response = await fetch(
                `https://black.irdop.org/xlsx/download/${receipt_uid}`,
                {
                    method: "GET",
                    headers: {
            ...
            Swal.fire({
                ...
                text:
                    error.message ||
                    "Có lỗi xảy ra khi tải file Excel. Vui lòng thử lại",
            });
        }
    };
            ...
            if (response.status === 200) {
                ...
                showToast(
                    `Đã cập nhật trạng thái thanh toán thành ${
                        newPayStatus === 1 ? "đã thanh toán" : "chưa thanh toán"
                    }!`,
                );
            } else {
                Swal.fire({
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                Swal.fire({
                    ...
                    title: "Lỗi",
                    text:
                        response.data?.message || "Lỗi khi cập nhật thông tin",
                });
                fetchReceipt(); // Refresh data on error
                return false;
            }
    ...
    const renderField = (
        ...
        if (disabled) {
            return (
                <div className="w-2/3 px-2 py-0 text-sm text-left border border-white">
                    {displayText}
                </div>
            );
        }
    ...
    const getDraftReport = (reports) => {
        ...
        return reports.find(
            (report) => report.ppt_uid && report.ppt_uid.includes("DRAFT"),
        );
    };
        ...
        return (
            <div className="overflow-x-auto overflow-hidden">
                <table className="min-w-full text-black">
                    <thead>
                        <tr>
                            <th className="py-2 border-2 text-start pl-2 w-36 min-w-36">
                                Mã mẫu thử
                            </th>
                            <th className="py-2 border-2 text-start pl-2 w-[18%] min-w-44">
                                Chỉ tiêu
                            </th>
                            <th className="py-2 border-2 text-start pl-2 w-[12%] min-w-32">
                                Lần cuối cập nhật
                            </th>
                            <th className="py-2 border-2 text-start pl-2 w-[20%] min-w-48">
                                Mã phiếu phân tích
                            </th>
                            <th className="py-2 border-2 text-start pl-2 w-32 min-w-32">
                                Ngày phát hành
                            </th>
                        ...
                        {currentReceipt?.samples.map((sample) => {
                            ...
                            const selectedReportId =
                                ...
                                (latestPublishedReport
                                    ? latestPublishedReport.ppt_uid
                                    : "");

                            // Find the selected report object
                            const selectedReport = reports.find(
                                (r) => r.ppt_uid === selectedReportId,
                            );
                                ...
                                <tr key={sample.id}>
                                    ...
                                    <td className="p-2 border text-center">
                                        <input
                                            ...
                                            onChange={() =>
                                                handleCheckboxToggle(sample.id)
                                            }
                                        />
                                    </td>
                                </tr>
        ...
        <div className="w-full">
                ...
                <div className="flex items-center flex-wrap ">
                    ...
                    >
                        <div className="flex items-center ">
                            {"Excel"}{" "}
                            <PiDownloadSimpleBold size={20} className="ml-1" />
                        </div>
                    </button>
                    <CreateReceipt
                        receipt={currentReceipt}
                        setUpdatedReceipt={setCurrentReceipt}
                    />
                    <button
                ...
                <div className="flex flex-col md:flex-row">
                    ...
                    <div className="w-full md:w-2/5 flex flex-col items-start px-2">
                        <div className="flex justify-start items-center mb-1">
                            ...
                            />
                            <h2 className="text-md font-semibold w-fit text-primary px-1">
                                THÔNG TIN CHUNG
                            </h2>
                        </div>
                        <div className="w-full">
                            ...
                            <div className="flex justify-start items-start mb-1">
                                ...
                                {editingGeneralField === "deadline" ? (
                                    ...
                                    <div
                                        className="w-2/3 px-2 py-0 text-sm text-left cursor-pointer border border-white hover:border-gray-300 rounded-lg"
                                        onClick={() =>
                                            setEditingGeneralField("deadline")
                                        }
                                    >
                                        {currentReceipt?.deadline
                                            ? formatDate(
                            ...
                            {isCustomerDetailsVisible && (
                                <>
                                    <div className="flex justify-start items-start mb-1">
                                        ...
                                        {renderField(
                                            "client.client_uid",
                                            currentReceipt?.client?.client_uid,
                                        )}
                                    </div>
                                    <div className="flex justify-start items-start mb-1">
                                        <label className="block text-sm font-medium text-gray-700 min-w-32 text-left">
                                    ...
                                    <div className="flex justify-start items-start mb-1">
                                        ...
                                        {renderField(
                                            "client.legal_id",
                                            currentReceipt?.client?.legal_id,
                                        )}
                                    </div>
                                    <div className="flex justify-start items-start mb-1">
                                        <label className="block text-sm font-medium text-gray-700 min-w-32 text-left">
            ...
            <div className="bg-white rounded-lg w-full mb-4 p-4">
                <div className="flex justify-end items-start sm:h-10 sm:flex-row flex-col h-[76px] ">
                    {viewMode === "analyte" ? (
                        <FilterBar
                            source={currentReceipt.samples.flatMap(
                        ...
                        <div className="flex items-center space-x-2">
                            <button className="bg-blue-500 text-white px-1 py-1 rounded-lg w-36">
                                Xuất PPT
                            </button>
                        </div>
                    ) : (
                        <div className="flex items-center space-x-2">
                            ...
                            <button
                                className="bg-blue-500 text-white px-1 py-1 rounded-lg w-36"
                                ...
                                <table className="text-black w-full relative z-0">
                                    <thead>
                                        <tr className="border-y-2">
                                            <th className="py-2 border-x w-36 min-w-36">
                                                Mã mẫu thử
                                            </th>
                                            <th className="py-2 border-x w-[22%] min-w-60">
                                                Chỉ tiêu
                                            </th>
                                            <th className="py-2 border-x w-[20%] min-w-44">
                                                Phương pháp
                                            </th>
                                            <th className="py-2 border-x w-1/12 min-w-20">
                                                Kết quả
                                            </th>
                                            <th className="py-2 border-x w-1/12 min-w-20">
                                                Đơn vị
                                            </th>
                                            <th className="py-2 border-x w-1/12 min-w-28">
                                                Hạn trả
                                            </th>
                                            <th className="py-2 border-x w-[12%] min-w-36">
                                                Người thực hiện
                                            </th>
                                            <th className="py-2 border-2 text-center w-14 min-w-14">
                                                Xóa
                            ...
                            <table className="min-w-full text-black">
                                <thead>
                                    <tr className="">
                                        ...
                                        <th className="py-2 border-2 text-start pl-2 w-28 min-w-28">
                                            Mục đích
                                        </th>
                                        <th className="py-2 border-2 text-start pl-2 w-28 min-w-28">
                                            Chỉ tiêu
                                        </th>
                                        <th className="py-2 border-2 text-start pl-2 w-[14%] min-w-36">
                                            Yêu cầu
                                        </th>
                                        <th className="py-2 border-2 text-center  w-14 min-w-14">
                                            Xóa
                                ...
                                <tbody className="border-2">
                                    {currentReceipt?.samples.map(
                                        (sample, sampleIndex) => {
                                            const totalTests =
                                                sample.analysis.length;
